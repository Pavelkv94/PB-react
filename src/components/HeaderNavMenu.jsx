...
const HeaderNavMenu = ({ isDarkTheme, setOpenModal, screenSize }) => {
      ...
      {!isMobileSize ? (
        ...
        <div className={styles.mobileContent}>
          ...
          <div className={styles.rightContentMobile}>
            ...
            <div className={styles.gamburgerWrapperMobile}>
              <div className={`${styles.menuGamburger} ${openMobileMenu ? styles.active : ""}`} onClick={() => setOpenMobileMenu(!openMobileMenu)}>
                <span></span>
                <span></span>
                <span></span>
              </div>
